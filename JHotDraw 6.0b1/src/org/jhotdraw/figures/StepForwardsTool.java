...
/**
 * Tool to step forwards a figure
 *
 * @version <$CURRENT_VERSION$>
 */
public class StepForwardsTool extends AbstractTool {
	...
	public StepForwardsTool(DrawingEditor newDrawingEditor) {
		super(newDrawingEditor);
		this.cmd = new UndoableCommand(new StepForwardsCommand("Step Forwards", newDrawingEditor));
	...
	private FigureSelectionListener createFigureSelectionChangeListener() {
		this.fsl = new FigureSelectionListener() {
			public void figureSelectionChanged(DrawingView view) {
				StepForwardsTool.this.figureSelectionChanged(view);
			}			
		};
